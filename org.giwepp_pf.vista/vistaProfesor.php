...
$profesores = new bdPersona();
$todoProfesores = $profesores->seleccionarTodoProfesor();
?>
<!DOCTYPE html>
<html lang="en">
    <head>
                    ...
                    <div class="section-body contain-lg">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-offset-1 col-md-8">
                                <h1 class="text-primary">Registro Profesor</h1>
                            </div><!--end .col -->

                            <div class="col-lg-offset-1 col-md-10">
                                <form class="form form-validate floating-label" novalidate="novalidate" action="../org.giwepp_pf.bd/bd_Registro_profesor.php" method="POST">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                              ...
                                              <div class="form-group">
                                                ...
                                                <label for="txtUsuario">Usuario de cuenta de profesor</label>
                                            </div>
                                        ...
                                        <div class="card-actionbar">
                                            <div class="card-actionbar-row">
                                                <button type="submit" class="btn btn-flat btn-primary ink-reaction" name="Registra_profesor" value="Registra_profesor">Registrar</button>
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h4>Datos generales de los Profesores/Maestros registrados en sistema</h4>
                            </div>
                            <div class="col-lg-12">
                                ...
                                <div class="card">
                                    <div class="table-responsive">
                                        <table id="datatable1" class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                <?php foreach ($todoProfesores as $row): ?>
                                                    <tr>
