...
$personas = new bdPersona();
$todoPersonas_sc = $personas->seleccionarTodoPersonas_SC();
?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <title>Relacionar cuentas</title>
                    ...
                    <div class="section-body contain-lg">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-offset-1 col-md-8">
                                <h1 class="text-primary">Registro de cuenta a una persona</h1>
                            </div><!--end .col -->

                            <div class="col-lg-offset-1 col-md-10">
                                <form class="form form-validate floating-label" novalidate="novalidate" action="../org.giwepp_pf.controlador/agregarCuenta.php" method="POST">
                                    <div class="card">
                                        <div class="card-body">
                                             ...
                                             <div class="form-group">
                                                <select name="txtTipocuenta">
                                                  <option value="1">Encargado de control escolar</option> 
                                                  <option value="2">Estudiante</option> 
                                                  <option value="3">Maestro</option> 
                                                  <option value="4">Director de area</option> 
                                                  </select>
                                                
                                            </div>

                                             <div class="form-group">
                                                <input type="text" class="form-control" id="txtIdusuario" name="txtIdusuario" required data-rule-minlength="2">
                                                <label for="txtIdusuario">Id del usuario registrado</label>
                                            </div>
                                ...
                                <div class="card">
                                    <div class="table-responsive">
                                        <table id="datatable1" class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                <?php foreach ($todoPersonas_sc as $row): ?>
                                                    <tr>
