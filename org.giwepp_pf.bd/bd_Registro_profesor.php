...
<?php
  ...
  if(isset($_POST['Registra_profesor']))
  {
    extract($_POST);
...

    {
      ...
      else
      {
            ...
            ('".$id_persona_registrada_ahora."', '".$txtCorreo."', '".$txtUsuario."', '".$txtContraseña."', 3) ";
            mysql_query($consulta);
            ...
            if($registro!=0)
            {
            echo '<br>  <br>  <center> Exito al registrar al Profesor/Maestro ';
            ...
            echo '<br> <br> <a href="../org.giwepp_pf.vista/vistaProfesor.php"><span>Registrar a otro profesor/maestro</span></a> </center>';
          //echo "<meta http-equiv='refresh' content='1;url=realizar_compra.php?num_compra=".$id_compra."&num_proveedor=".$id_proveedor."&precio_compra_prod=".$productos['p_precio_compra']."&precio_por_cantidad=".$cantidad."'>";
            ...
            {
             echo '<br>  <br>  <center> Error al registrar al Profesor/Maestro, llame a soporte ' .$id_persona_registrada_ahora. ' ' .$persona['id_persona'] .'</center>';
            }
